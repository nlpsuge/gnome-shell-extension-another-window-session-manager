...
class AwsIndicator extends PanelMenu.Button {
    ...
    _sessionChanged(monitor, fileMonitored, otherFile, eventType) {
        ...
        this._log.debug(`Session changed, readd all session items from ${this._sessions_path}. ${pathMonitored} changed. other_file: ${otherFile?.get_path()}. Event type: ${eventType}`);
